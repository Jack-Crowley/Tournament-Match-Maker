...
export default function TeamsPage() {
    const teams = [
        { id: 1, name: 'Team 1', membersCount: 12, image: '/team.jpg' },
        { id: 2, name: 'Team 2', membersCount: 8, image: '/team.jpg' },
        { id: 3, name: 'Team 3', membersCount: 15, image: '/team.jpg' },
        { id: 4, name: 'Team 4', membersCount: 10, image: '/team.jpg' },
    ];
